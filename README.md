...
`${GOPATH}/src/github.com/txtweet/test_velo_b1`
...
```
git remote set-url origin https://github.com/txtweet/test_velo_b1
...
in the same directory with the name test_velo_b1.
...
```
./test_velo_b1 -c test_velo_b1.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/txtweet/test_velo_b1
git clone https://github.com/txtweet/test_velo_b1 ${GOPATH}/src/github.com/txtweet/test_velo_b1
```
